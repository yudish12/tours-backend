...
},{"./alert.js":"alert.js","axios":"../../node_modules/axios/index.js"}],"mapBox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieXVkaTMxMzQiLCJhIjoiY2xoMGFidnl2MHJveDN0cGM0cW5rMWN2NSJ9.a8t9dK-tarzaVEIjGlU1wg';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('http://localhost:5000/api/v1/users/signup', {
            email: email,
            password: password,
            name: name,
        ...
        case 3:
          ...
          if (res.data.message === 'User signed up successfully') {
            (0, _alert.showAlert)('success', 'User signed up successfully');
            window.setTimeout(function () {
              location.assign('/');
            }, 500);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateMe.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _axios.default.patch("http://localhost:5000/api/v1/users/".concat(url), data);
        case 4:
          res = _context.sent;
          console.log('xcas');
          if (res.data.message === 'success' || res.data.message === 'password updated sucessfully') {
            (0, _alert.showAlert)('success', 'user info updated successfully');
            window.setTimeout(function () {
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var forgotHandler = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Email Sent successfully.Please check your inbox');
            //   window.setTimeout(() => {
            //     location.reload(true);
            //   }, 5000);
          }
  ...
  return function forgotHandler(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.forgotHandler = forgotHandler;
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"ResetPass.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var resetHandler = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 2;
          _context.next = 5;
          return _axios.default.patch("http://localhost:5000/api/v1/users/resetPassword/".concat(token), {
            password: password,
            passwordConfirm: passwordConfirm
          });
        case 5:
  ...
  return function resetHandler(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var forgotPasswordFormBtn = document.querySelector('.forgotPassword-form h3');
var closePopup = document.querySelector('.closePopup');
var forgotPasswordForm = document.querySelector('.forgotPasswordForm');
var newPasswordForm = document.querySelector('.NewPass');
if (mapBox) {
...
if (Loginform) {
  Loginform.addEventListener('submit', function (e) {
    ...
    var passwrod = Loginform.elements['password'].value;
    (0, _login.Login)(email, passwrod);
  });
}
console.log('x');
if (Signupform) {
  Signupform.addEventListener('submit', function (e) {
    ...
    var passwrod = Signupform.elements['password'].value;
    var passwrodConfirm = Signupform.elements['passwordConfirm'].value;
    var name = Signupform.elements['name'].value;
    (0, _signup.signUp)(name, email, passwrod, passwrodConfirm);
  });
}
if (logoutBtn) {
...
if (updateForm) {
  ...
  updateForm.addEventListener('submit', function (e) {
    ...
    (0, _updateMe.update)(form, 'updateMe');
  });
}
if (passwordUpdateForm) {
  passwordUpdateForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var password = passwordUpdateForm.elements['password-current'].value;
    var newPassword = passwordUpdateForm.elements['password'].value;
    var confirmNewPassword = passwordUpdateForm.elements['password-confirm'].value;
    (0, _updateMe.update)({
      password: password,
...
if (forgotPasswordFormBtn) {
  forgotPasswordFormBtn.addEventListener('click', function () {
    var main = document.querySelector('.main');
    var loginContainer = document.querySelector('.login-form');
    var formForgot = document.querySelector('.forgotPasswordForm');
