...
if (Signupform) {
  Signupform.addEventListener('submit', function (e) {
    ...
    var email = Loginform.elements['email'].value;
    var passwrod = Loginform.elements['password'].value;
    var passwrodConfirm = Loginform.elements['passwordConfirm'].value;
...
if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = updateForm.elements['email'].value;
    var name = updateForm.elements['name'].value;
    (0, _updateMe.update)({
      email: email,
      name: name
    }, 'updateMe');
